(function($){
	...
	var set=$.extend({'contentLocation':'tipuesearch/tipuesearch_content.json',
			  'contextBuffer':60,
			  'contextLength':60,
			  'contextStart':90,
			  'debug':false,
	...
	return this.each(function(){
	    ...
	    $('#tipue_search_content').hide().html('<div class="tipue_search_spinner"><div class="tipue_search_rect1"></div><div class="tipue_search_rect2"></div><div class="rect3"></div></div>').show();if(set.mode=='live')
